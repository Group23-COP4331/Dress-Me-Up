                    ...
                    children: [
                      ...
                      TextField(
                        ...
                        decoration: inputDecoration.copyWith(
                          ...
                          prefixIcon: Icon(Icons.person_outline, color: Color(0xFF5E5340)),
                        ),
                      ),
                      ...
                      TextField(
                        ...
                        decoration: inputDecoration.copyWith(
                          labelText: 'Last Name',
                          prefixIcon: Icon(Icons.people_alt_outlined, color: Color(0xFF5E5340)),
                        ),
                      ),
                      const SizedBox(height: 20),
                      TextField(
                        ...
                        decoration: inputDecoration.copyWith(
                          labelText: 'Email',
                          prefixIcon: Icon(Icons.email_outlined, color: Color(0xFF5E5340)),
                        ),
                      ),
                      const SizedBox(height: 20),
                      TextField(
                        ...
                        decoration: inputDecoration.copyWith(
                          labelText: 'Password',
                          prefixIcon: Icon(Icons.lock_outlined, color: Color(0xFF5E5340)),
                        ),
                      ),
                      const SizedBox(height: 20),
                      TextField(
                        ...
                        decoration: inputDecoration.copyWith(
                          labelText: 'Country',
                          prefixIcon: Icon(Icons.flag_outlined, color: Color(0xFF5E5340)),
                        ),
                      ),
                      const SizedBox(height: 20),
                      TextField(
                        ...
                        decoration: inputDecoration.copyWith(
                          labelText: 'City',
                          prefixIcon: Icon(Icons.location_city_outlined, color: Color(0xFF5E5340)),
                        ),
                      ),
